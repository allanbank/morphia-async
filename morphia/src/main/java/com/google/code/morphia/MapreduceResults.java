...
public class MapreduceResults<T> implements Iterable<T> {
    ...
    public void setInlineRequiredOptions(Class<T> clazz, Mapper mapr,
            EntityCache cache) {
        this.clazz = clazz;
        this.mapr = mapr;
        this.cache = cache;
    ...
    public Iterator<T> getInlineResults() {
        return new MorphiaIterator<T, T>(
                (Iterator<Document>) rawResults.get("results"), mapr, clazz,
                null, cache);
    }
