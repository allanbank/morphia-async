...
public class ContradictingFieldAnnotation extends FieldConstraint {
    ...
    public ContradictingFieldAnnotation(final Class<? extends Annotation> a1,
            final Class<? extends Annotation> a2) {
        this.a1 = a1;
        this.a2 = a2;
    }

    @Override
    protected final void check(final MappedClass mc, final MappedField mf,
        ...
        if (mf.hasAnnotation(a1) && mf.hasAnnotation(a2)) {
            ve.add(new ConstraintViolation(Level.FATAL, mc, mf,
                    this.getClass(), "A field can be either annotated with @"
