...
public class IntegerConverter extends TypeConverter<Integer> implements
    ...
    @Override
    public Integer decode(Class targetClass, Element val,
        ...
        if ((val == null) || (val.getType() == ElementType.NULL)) {
            ...
            return Integer.valueOf(((NumericElement) val).getIntValue());
        }
        else if (val.getType() == ElementType.STRING) {
            String sVal = ((StringElement) val).getValue();
            return Integer.valueOf(Integer.parseInt(sVal));
        }
        ...
        throw new MappingException("Could not figure out how to map a "
                + val.getClass().getSimpleName() + " into a Integer.");
    }

    @Override
    public void encode(DocumentBuilder builder, String name, Integer value,
