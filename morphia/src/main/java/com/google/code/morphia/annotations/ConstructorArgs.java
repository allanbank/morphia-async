...
/**
 * Indicates that this field can be constructed from the stored fields; it
 * doesn't require a no-args constructor. Please list the names of args/fields,
 * in order.
 * 
...
public @interface ConstructorArgs {
    /** The constructor argument field names. */
    String[] value();
}
