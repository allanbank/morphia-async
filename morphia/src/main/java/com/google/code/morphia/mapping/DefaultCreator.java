...
public class DefaultCreator implements ObjectFactory {
    private static final Logr log = MorphiaLoggerFactory
            .get(DefaultCreator.class);

    /*
     * (non-Javadoc)
     * 
     * @see
     * com.google.code.morphia.ObjectFactory#createInstance(java.lang.Class)
     */
     ...
     * 
     * @see
     * com.google.code.morphia.ObjectFactory#createInstance(com.google.code.
     * morphia.mapping.Mapper, com.google.code.morphia.mapping.MappedField,
     * com.mongodb.DBObject)
     */
    public Object createInstance(Mapper mapr, MappedField mf, Document dbObj) {
        ...
        try {
            ...
            if (argAnn == null)
                throw e;
            // TODO: now that we have a mapr, get the arg types that way by
            // getting the fields by name. + Validate names
            ...
            for (int i = 0; i < argAnn.value().length; i++) {
                // TODO: run converters and stuff against these. Kinda like the
                // List of List stuff, using a fake MappedField to hold the
                // value
    ...
    private Class getClass(Document dbObj) {
        // see if there is a className value
        StringElement className = dbObj.get(StringElement.class,
        ...
        if (className != null) {
            ...
            try {
                c = Class.forName(className.getValue(), true,
                        getClassLoaderForClass(className.getValue(), dbObj));
            }
    ...
    protected ClassLoader getClassLoaderForClass(String clazz, Document object) {
     ...
     * 
     * @see
     * com.google.code.morphia.ObjectFactory#createMap(com.google.code.morphia
     * .mapping.MappedField)
     */
     ...
     * 
     * @see
     * com.google.code.morphia.ObjectFactory#createList(com.google.code.morphia
     * .mapping.MappedField)
     */
     ...
     * 
     * @see
     * com.google.code.morphia.ObjectFactory#createSet(com.google.code.morphia
     * .mapping.MappedField)
     */
     ...
     * fallbackType
     */
    private static Object newInstance(final Constructor tryMe,
