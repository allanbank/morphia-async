...
public class MappingValidator {
    ...
    private List<ClassConstraint> getConstraints() {
        ...
        //
        constraints.add(new ContradictingFieldAnnotation(Reference.class,
                Serialized.class));
        constraints.add(new ContradictingFieldAnnotation(Reference.class,
                Property.class));
        constraints.add(new ContradictingFieldAnnotation(Reference.class,
        ...
        constraints.add(new ContradictingFieldAnnotation(Embedded.class,
                Property.class));
        //
        constraints.add(new ContradictingFieldAnnotation(Property.class,
                Serialized.class));
    ...
    class LogLine implements Comparable<LogLine> {
        ...
        void log(final Logger logger) {
            ...
            default:
                throw new IllegalStateException("Cannot log "
